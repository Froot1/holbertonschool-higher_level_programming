...
class Square:
    ...
    Attributes:
        ...
        __position (tuple): Private instance attribute representing position.
    """
    ...
    def my_print(self):
        ...
        If size is 0, prints an empty line. Position is used to offset
        the square horizontally and vertically.
        """
        if self.__size == 0:
            print()
            return
