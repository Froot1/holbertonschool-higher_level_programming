<p align="center">
<img width="520" align="center" altlt="Image" src="https://github.com/user-attachments/assets/d987a100-2f3d-4482-b580-f22bfd11d4de" />
</p>
...
* Tasks 10-18 query from the database [hbtn_0d_tvshows.sql](./hbtn_0d_tvshows.sql).
* Tasks 19-20 query from the database [hbtn_0d_tvshows_rate.sql](./hbtn_0d_tvshows_rate.sql).
